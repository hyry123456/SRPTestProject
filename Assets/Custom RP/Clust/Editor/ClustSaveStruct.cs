...
public class ClustSaveStruct
{
    ...
    public struct Triangle
    {
        ...
        public Vector3 GetCenter(ClustSaveStruct clustSaveStruct)
        {
    ...
    public struct Quardrangle
    {
        ...
        public QuardrangleMeshData GetMeshData(ClustSaveStruct clustSaveStruct)
        {
            Vector3[] vectes = new Vector3[4];
        ...
        public Mesh GetMesh(ClustSaveStruct clustSaveStruct)
        {
            Vector3[] vectes = new Vector3[4];
        ...
        public float GetDistance(Quardrangle queue, ClustSaveStruct clustSaveStruct)
        {
