...
public class ClustDataLoad
{
    ...
    public static List<ClustData> LoadClust(string path)
    {
        ...
        List<string> clipClust = ClipAllClustData(allStr);
    ...
    private static string LoadAllStr(string path)
    {
        if (File.Exists(path))
        {
    ...
    //切割每一个Clust数据
    private static List<string> ClipAllClustData(string allStr)
    {
