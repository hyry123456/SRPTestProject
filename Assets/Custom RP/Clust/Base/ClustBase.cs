...
namespace CustomRP.Clust
{
    ...
    /// </summary>
    public partial class ClustBase : MonoBehaviour
    {
        public string savePath = "clustSaveData.clustData";
        ...
        private void Awake()
        {
            ...
            List<ClustDataLoad.ClustData> clustData = 
                ClustDataLoad.LoadClust(Application.streamingAssetsPath + "/ClustData/" + savePath);
        ...
        private void Start()
        {
            ClustDrawStack.Instance.InsertClustBase(this);
            isInsert = true;
        }

        void ExecuteBuffer(ref CommandBuffer buffer, ScriptableRenderContext context)
        {
            context.ExecuteCommandBuffer(buffer);
            buffer.Clear();
        }

        public virtual void DrawClustByCamera(ScriptableRenderContext context,
        ...
        public virtual void DrawClustByProjectMatrix(ScriptableRenderContext context,
        ...
        private void OnDestroy()
        {
            if (isInsert)
            {
                ClustDrawStack.Instance.RemoveClustBase(this);
                isInsert = false;
            }
